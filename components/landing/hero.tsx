                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center">
                        <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-6xl">
                            Supercharge your <span className="text-indigo-600 dark:text-indigo-400">B2B Sales</span> with automation.
                        </h1>
                        <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                            The all-in-one CRM built for speed. Manage leads, track deals, and automate your outreach without the clutter.
                        </p>
                    ...
                    <div className="mt-16 flow-root sm:mt-24">
                        <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 dark:bg-white/5 dark:ring-white/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                            <img
                                src="https://placehold.co/2400x1600/1e1e2e/ffffff.png?text=Dashboard+Preview&font=montserrat"
                                alt="App screenshot"
                                width={2432}
                                height={1442}
