            ...
            <div className="max-w-md w-full space-y-8">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Or use the demo account: <br />
                        <code className="bg-gray-100 px-1 py-0.5 rounded">admin@demo.com</code> / <code className="bg-gray-100 px-1 py-0.5 rounded">password123</code>
                    </p>
                    <p className="mt-2 text-center text-sm text-gray-600">
